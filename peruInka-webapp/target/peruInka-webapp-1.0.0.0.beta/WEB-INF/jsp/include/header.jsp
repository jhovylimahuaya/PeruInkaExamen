			...
			<div class="nav-collapse">
				<nav class="nav">
					<ul class="nav">
						...
						<li <c:if test="${menuHeader eq 'hotels'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/home/hotels">Hoteles</a></li>
						<li <c:if test="${menuHeader eq 'products'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/home/products">Productos</a></li>
						<li <c:if test="${menuHeader eq 'Enterprice'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/home/Enterprice">Empresas</a></li>
						<li <c:if test="${menuHeader eq 'customers'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/home/customers">Clientes</a></li>
